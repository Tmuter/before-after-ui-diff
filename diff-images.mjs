 ...
 *   UI_DIFF_PASS_PCT=0.02      % of changed pixels at/below which the row auto-passes
 *
 * The ONE allowed dependency island in this package: pixelmatch + pngjs.
 * Everything else in before-after-ui-diff stays dependency-free (Node global WebSocket + fetch).
 */
...
const passPct = +(process.env.UI_DIFF_PASS_PCT || 0.02);
